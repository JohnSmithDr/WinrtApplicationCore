...
{
    public class ReactiveGroupedListViewModel<TGroupKey, T> : ReactiveObject, IBackCommandOverride
    {
        public ReactiveGroupedListViewModel(IViewNavigation navigation)
        {
            this.Navigation = navigation;
            this.GroupedItems = new ReactiveGroupedList<TGroupKey, T>();
            ...
            this.Select = this
                .WhenAnyValue(x => x.IsSelectionEnabled, x => x.GroupedItems.IsElementEmpty, (a, b) => !(a || b))
                .ToCommand(() =>
                {
            ...
            this.SelectAll = this
                ...
                {
                    SelectedItems.Clear();
                    SelectedItems.AddRange(GroupedItems.Elements);
                })
                .Command;
            ...
            this.WhenAnyValue(x => x.IsItemsLoaded, x => x.GroupedItems.IsElementEmpty, (a, b) => a && b)
        ...
        public IReactiveGroupedList<TGroupKey, T> GroupedItems { get; protected set; }
